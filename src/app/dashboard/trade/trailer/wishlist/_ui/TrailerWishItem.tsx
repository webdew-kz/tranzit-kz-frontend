...
import { addView, getIsInWishlist, removeFromWishlist } from '../../search/actions'
...
const TrailerWishItem = memo(
	({ trailerInitial, rates, loading, setWishlistLength, setTrailers }: TrailerSearchItemProps) => {
		...
		const handleRemoveFromWishlist = async () => {
			...
			if (setTrailers) {
				setTrailers(prevTrailers => prevTrailers.filter(t => t.id !== trailer.id));
			}
...
export default TrailerWishItem
