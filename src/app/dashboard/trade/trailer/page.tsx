	...
	return (
		<div className=' flex flex-col gap-4 justify-center h-[calc(100vh-160px)]'>
			...
			>
				...
				<Link
					href='/dashboard/trade/trailer/add'
					className='flex gap-3 items-center justify-start'
				>
					<ArrowBigUp /> Продать прицепы и полуприцепы
				</Link>
			</Button>
			<Button
				variant={'outline'}
			...
			>
				...
				<Link
					...
					className='flex gap-3 items-center justify-start'
				>
					<ArrowBigDown /> Купить прицепы и полуприцепы
				</Link>
			</Button>
			<Button
				variant={'outline'}
			...
			>
				...
				<Link
					...
					className='flex gap-3 items-center justify-start'
				>
					<Star /> Избранные прицепы и полуприцепы
				</Link>
			</Button>
			<Button
				variant={'outline'}
			...
			>
				...
				<Link
					href='/dashboard/trade/trailer/my'
					className='flex gap-3 items-center justify-start'
				>
