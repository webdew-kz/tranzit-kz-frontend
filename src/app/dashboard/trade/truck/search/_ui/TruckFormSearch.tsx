...
import { DriveEnum, ExistEnum, StatusEnum, SteeringEnum, TransmissionEnum, TruckBrandEnum, TruckWheelEnum, TypeEngineEnum, TypeTruckEnum, VariantEnum } from '@/shared/types/truck.type';
...
export default function TruckFormSearch() {

	const { setSearchTrucks } = useTruckSearchStore()

	const { setTrucks } = useTruckStore()
	...
	const truckSchema = z.object({
		...
		truckBrand: z.enum(Object.keys(TruckBrandEnum) as [keyof typeof TruckBrandEnum]).optional(),
		typeTruck: z.enum(Object.keys(TypeTruckEnum) as [keyof typeof TypeTruckEnum]).optional(),
