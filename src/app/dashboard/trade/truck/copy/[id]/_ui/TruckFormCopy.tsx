...
import { addTruck } from '../../../add/actions';
...
import { copyTruck, getTruck } from '../actions';
import { cn } from '@/shared/lib/utils';
import { CityInput } from '@/shared/components/widgets/CityInput';

interface ITruckFormCopyProps {
	id: string
}

export default function TruckFormCopy({ id }: ITruckFormCopyProps) {
	...
	const onSubmit = async (data: Truck) => {
		...
		startTransition(async () => {
			...
			try {
				const res = await copyTruck(data, oldPhotos)
