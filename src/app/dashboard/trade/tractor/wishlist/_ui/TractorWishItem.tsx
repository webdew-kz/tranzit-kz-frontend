...
interface TractorSearchItemProps {
	...
	setTractors?: React.Dispatch<React.SetStateAction<ITractor[]>>
	rates?: any
	loading?: boolean
	setWishlistLength?: React.Dispatch<React.SetStateAction<number>>;
}

const TractorWishItem = memo(
	({ tractorInitial, rates, loading, setWishlistLength, setTractors }: TractorSearchItemProps) => {
		...
		const handleRemoveFromWishlist = async () => {
			...
			if (setTractors) {
				setTractors(prevTractors => prevTractors.filter(t => t.id !== tractor.id));
			}
...
export default TractorWishItem
