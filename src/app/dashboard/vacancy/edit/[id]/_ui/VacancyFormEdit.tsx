...
export default function VacancyFormEdit({ id }: { id?: string }) {
	...
	return (
		<Card className="w-full p-3 md:p-5 gap-3 md:gap-5 ">
			<CardHeader className='px-0'>
				<CardTitle className='text-xl text-center'>Редактировать вакансию</CardTitle>
			</CardHeader>
