...
export default function DashboardPage() {
	...
	return (
		...
		<div className="h-[calc(100vh-160px)] sm:h-[calc(100vh-60px)] flex flex-col gap-3 md:gap-5 items-center pt-5 justify-center">
			<div className="flex flex-col gap-3 md:gap-5  items-center justify-center p-5 bg-background w-[calc(100vw-32px)] max-w-full sm:max-w-xs -translate-y-6 rounded-lg border-(--dark-accent) border opacity-70">
				...
				<div className="flex flex-col justify-center w-full gap-3 md:gap-5 items-center">
					<div className="text-center">Мы объединяем грузовладельцев и транспортные компании, чтобы каждый груз дошёл точно в срок. Удобный поиск, прозрачные условия и проверенные партнёры — всё для вашего спокойствия.</div>
				</div>
			</div>
		</div>
	)
