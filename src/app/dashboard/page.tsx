...
export default function DashboardPage() {
	...
	return (
		...
		<div className="h-[calc(100vh-160px)] sm:h-[calc(100vh-60px)] bg-[url(/images/bg-home.jpg)] md:bg-[url(/images/bg-home-full.jpg)] bg-no-repeat bg-cover bg-center flex items-center justify-center">
