			...
			<div className="grid gap-2">
				...
				<ul className=' grid gap-2'>
					...
					<li className={cn('px-3 rounded-sm hover:bg-(--dark-accent) asideLink transition-all duration-200', `${pathname.startsWith('/dashboard/trade/parts') ? 'bg-(--dark-accent)' : ''}`)}>
						...
						>
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn('w-4 h-4 transition-all duration-200 hover:svgPathDark', `${pathname.startsWith('/dashboard/trade/parts') ? 'svgPathDark' : 'svgPathAccent'}`)}>
