...
import { activateBroker } from '../../actions'
...
const MyBrokerArchiveItem = memo(({ brokerInitial, selected, onToggle, setBrokers, rates, loading }: MyBrokerItemProps) => {
...
export default MyBrokerArchiveItem